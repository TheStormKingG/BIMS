      ...
      <div className={`${showChatList && window.innerWidth < 768 ? 'hidden' : 'flex'} md:flex flex-1 flex-col bg-[#0b141a] relative overflow-hidden`} style={{ maxWidth: '100%', overflowX: 'hidden' }}>
        {!currentSession ? (
          ...
          <>
            ...
            {/* Messages */}
            <div className="flex-1 overflow-y-auto px-4 py-2 pb-[88px] md:pb-4" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'100\' height=\'100\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cdefs%3E%3Cpattern id=\'grid\' width=\'100\' height=\'100\' patternUnits=\'userSpaceOnUse\'%3E%3Cpath d=\'M 100 0 L 0 0 0 100\' fill=\'none\' stroke=\'%231f2937\' stroke-width=\'1\' opacity=\'0.3\'/%3E%3C/pattern%3E%3C/defs%3E%3Crect width=\'100%25\' height=\'100%25\' fill=\'url(%23grid)\'/%3E%3C/svg%3E")' }}>
              {messages.length === 0 ? (
                <div className="flex items-center justify-center h-full">
