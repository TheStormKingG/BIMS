-- Run this migration in Supabase SQL Editor to create the user_celebrations and user_events tables
-- This migration is also available in supabase/migrations/009_user_events_and_celebrations.sql
