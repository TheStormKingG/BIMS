-- Update Existing Phase Certificate Descriptions
-- Run this script in your Supabase SQL Editor to update existing phase certificates
-- with the new 30-word transcript descriptions
