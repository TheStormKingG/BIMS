-- Cleanup Duplicate Cash Wallets
-- Run this in Supabase SQL Editor to clean up duplicate Cash Wallet entries
-- This script consolidates duplicate Cash Wallet entries per user into a single wallet
...
DROP INDEX IF EXISTS idx_unique_cash_wallet_null_user;
